...
pub enum MessageType {
    ...
    PUT_IMAGE_ZSTD = 178,
    PUT_TILE_ZSTD = 179,
    CANVAS_BACKGROUND_ZSTD = 180,
    MOVE_RECT_ZSTD = 181,
    TRANSFORM_REGION_ZSTD = 182,
    UNDO = 255,
}
...
impl MessageType {
    pub fn from_u8(value: u8) -> Result<Self> {
        match value {
            ...
            150 => Ok(MessageType::DRAW_DABS_PIXEL_SQUARE),
            ...
            178 => Ok(MessageType::PUT_IMAGE_ZSTD),
            179 => Ok(MessageType::PUT_TILE_ZSTD),
            180 => Ok(MessageType::CANVAS_BACKGROUND_ZSTD),
            181 => Ok(MessageType::MOVE_RECT_ZSTD),
            182 => Ok(MessageType::TRANSFORM_REGION_ZSTD),
